...
data <- read_rds("output_s_c/Summary_data_with_cause.rds")
...
cardiovascular_data <- combined_data %>%
  rename(deaths = total_deaths)

cardiovascular_year_summary <- cardiovascular_data %>%
  group_by(year) %>%
  summarise(
...
par(mfrow = c(1, 2))
plot(cardiovascular_year_summary$year, cardiovascular_year_summary$total_deaths, type = "o", col = "blue",
     xlab = "Year", ylab = "Total Deaths", main = "Cardiovascular Deaths Over Time")
plot(cardiovascular_year_summary$year, cardiovascular_year_summary$total_death_rate, type = "o", col = "red",
     xlab = "Year", ylab = "Total Death Rate", main = "Cardiovascular Death Rate Over Time")


cardiovascular_month <- cardiovascular_data %>%
  group_by(year, month) %>%
  summarise(
    total_deaths = sum(deaths, na.rm = TRUE),
...
cardiovascular_month_summary <- cardiovascular_month %>%
  group_by(month) %>%
  summarise(
...
plot(cardiovascular_month_summary$month, cardiovascular_month_summary$mean_deaths, type = "o", col = "blue",
              xlab = "Month", ylab = "Month Total Deaths", main = "Cardiovascular Deaths Over Time")
plot(cardiovascular_month_summary$month, cardiovascular_month_summary$mean_death_rate, type = "o", col = "red",
              xlab = "Month", ylab = "Month Total Death Rate", main = "Cardiovascular Death Rate Over Time")

plot6 <- grid.arrange(plot3, plot4, ncol = 2)
...
write.csv(cardiovascular_year_summary, "output_s/cardiovascular_year_summary.csv")
write.csv(cardiovascular_month_summary, "output_s/cardiovascular_month_summary.csv")
