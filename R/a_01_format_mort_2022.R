...
format_mort_2022 <- function(year, file_name) {
  ...
  start.positions.2 =   c(450,484,487,489)
  ...
  end.positions.2 	=   c(450,486,488,490)
  ...
  names.2		= c('racer5','hispanic','hispanicr','racer40')
...
format_mort_2022(2022, "MULT2022.USAllCnty.txt")

data_2022 <- read.csv("data/mort2022.csv", fileEncoding="latin1")
