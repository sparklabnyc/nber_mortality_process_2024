...
format_mort_2019_2020 <- function(year, file_name) {
...
names.1 	= c('rectype','restatus','stateoc_fips','countyoc_fips','popsizoc',
             'stateres_fips','countyrs_fips','popsize_countyrs','statbth','educ',
...
for (year in 2019:2020) {
  file_name <- paste0("MULT", year, ".USAllCnty.txt")
  format_mort_2019_2020(year, file_name)
}

data_2019 <- read.csv("data/mort2019.csv", fileEncoding="latin1")
