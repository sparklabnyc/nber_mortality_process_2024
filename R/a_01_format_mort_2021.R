...
format_mort_2021 <- function(year, file_name) {
  ...
  end.positions.2 	=   c(486,490)

  names.1 	= c('rectype','restatus','stateoc_fips','countyoc_fips','popsizoc',
               'stateres_fips','countyrs_fips','popsize_countyrs','statbth',
               'educr','monthdth','sex','age','placdth',
               'marstat','weekday','year','injwork','mandeath',
               'autopsy','activity','injury',
               'ucod','eanum',
  ...
  write.csv(dat_clean,here("data", paste0('mort', year, '.csv')))
}

format_mort_2021(2021, "MULT2021.USAllCnty.txt")

data_2021 <- read.csv("data/mort2021.csv", fileEncoding="latin1")
data_2020 <- read.csv("data/mort2020.csv", fileEncoding="latin1")
data_2018 <- read.csv("data/mort2018.csv", fileEncoding="latin1")
data_1999 <- read.csv("data/mort1999.csv", fileEncoding="latin1")
data_2004 <- read.csv("data/mort2004.csv", fileEncoding="latin1")
data_2005 <- read.csv("data/mort2005.csv", fileEncoding="latin1")
data_2001 <- read.csv("data/mort2001.csv", fileEncoding="latin1")
data_2002 <- read.csv("data/mort2002.csv", fileEncoding="latin1")
